...
import com.gosang.component.LoginHandlerInterceptor;
...
public class MvcConfig implements WebMvcConfigurer, ErrorPageRegistrar {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new LoginHandlerInterceptor()).addPathPatterns("/**")
                .excludePathPatterns(
                        "/","/temp-file","/error400Page","/error401Page","/error404Page","/error500Page","TempFile","/admin","/sendCode","/loginByQQ","/login","/register","/file/share","/connection",
